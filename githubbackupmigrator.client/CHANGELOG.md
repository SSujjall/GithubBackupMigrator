...
- Create Angular project with ng: `ng new githubbackupmigrator.client --defaults --skip-install --skip-git `.
...
- Create project file (`githubbackupmigrator.client.esproj`).
